    ...
    <div class="flex items-center justify-between gap-4">
        ...
        <div>
            ...
            <p class="text-slate-400 mt-1">
                Update account and practice details for {{ $user->nama }}.
            </p>
        </div>
                        ...
                        <div>
                            ...
                            <div class="relative mt-2">
                                ...
                                class="w-full pl-4 pr-10 py-3 rounded-2xl border border-slate-200 bg-white appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                                    ...
                                    <option value="Available" {{ optional($dokter)->status_ketersediaan == 'Available' ? 'selected' : '' }}>Available</option>
                                    <option value="Unavailable" {{ optional($dokter)->status_ketersediaan == 'Unavailable' ? 'selected' : '' }}>Unavailable</option>
