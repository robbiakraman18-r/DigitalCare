            ...
            <div class="flex items-center gap-5">
                ...
                <div class="mt-2">
                        ...
                        <div class="flex flex-wrap gap-2 mt-3">
                            <span class="px-3 py-1 rounded-xl bg-teal-100 text-teal-700 text-xs font-semibold">Super Admin</span>
                            <span class="px-3 py-1 rounded-xl bg-green-100 text-green-700 text-xs font-semibold">● Aktif</span>
                            <span class="px-3 py-1 rounded-xl bg-slate-100 text-slate-600 text-xs font-semibold">Full Access</span>
                        </div>
                    </div>
                </div>
