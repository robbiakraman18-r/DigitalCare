                ...
                <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" value="{{ Auth::user()->nama }}" class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-500" readonly>
                        </div>
                        <div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" value="{{ Auth::user()->birth_date ?? '-' }}" class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-500" readonly>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Gender</label>
                            <input type="text" value="{{ Auth::user()->gender ?? '-' }}" class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-500" readonly>
                        </div>
